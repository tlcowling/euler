...
primes = primes.select{
	...
	!(primey.include?(5.to_s) || primey.include?(4.to_s) || primey.include?(6.to_s)|| primey.include?(8.to_s) || primey.include?(2.to_s) || primey.include?(0.to_s)) && prime > 7
}
...
p "The sum of the #{num_trun_primes} truncatable primes is #{sum}"
